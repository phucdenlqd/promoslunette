...
class OrderOpcControllerCore extends ParentOrderController
{
    ...
    {
        if (!$this->isLogged) {
            return '<p class="warning">'.Tools::displayError('Please sign in to see payment methods.').'</p>'.'<div class="row"><div class="col-xs-12 col-md-12"><p class="payment_module paypal" style="color:black;cursor:not-allowed;font-size:12px;font-weight:400">Payez par carte ou par compte PayPal<img src="https://www.promoslunettes.com/modules/paypal/views/img/logos/FR_logo_paypal_moyens_paiement_fr.jpg" alt="Payez par carte ou par compte PayPal}" style="display:block" height="100px" /></p></div></div>'.'<div class="row"><div class="col-xs-12 col-md-12"><p class="payment_module paypal" style="color:black;cursor:not-allowed;font-size:12px;font-weight:400">Payez par carte Bancaire<img src="https://www.promoslunettes.com/modules/systempay/views/images/BannerLogo1.jpg" alt="Payez par carte bancaire}" style="display:block" height="100px" /></p></div></div>';
        }
