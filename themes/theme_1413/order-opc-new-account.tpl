<div id="opc_new_account" class="opc-main-block">
  ...
  <h4 class="step-num"><span>1</span> {l s='Account'}</h4>
  <form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
    <fieldset>
      <h3 style="display:inline-block;margin-right:10px;margin-bottom:0px" class="page-subheading">{l s='Already registered?'}</h3>
      <p style="display:inline-block"><a href="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" id="openLoginFormBlock">&raquo; {l s='Click here'}</a></p>
          ...
          *}
          ...
          {foreach from=$dlv_all_fields item=field_name}
            ...
            {elseif $field_name eq "firstname"}
              <div class="required text form-group" style="height:1px;width:1px">
                <label style="height:0px;width:0px;color:transparent" for="firstname">{l s='First name'} <sup style="height:0px;width:0px;color:transparent">*</sup></label>
                <input style="height:0px;width:0px;color:transparent" type="text" class="text form-control validate" id="firstname" name="firstname" data-validate="isName" value="{if isset($guestInformations) && isset($guestInformations.firstname) && $guestInformations.firstname}{$guestInformations.firstname}{/if}" />
              </div>
            {elseif $field_name eq "lastname"}
              <div class="required text form-group" style="height:1px;width:1px">
                <label style="height:0px;width:0px;color:transparent" for="lastname">{l s='Last name'} <sup style="height:0px;width:0px;color:transparent">*</sup></label>
                <input  style="height:0px;width:0px;color:transparent" type="text" class="text form-control validate" id="lastname" name="lastname" data-validate="isName" value="{if isset($guestInformations) && isset($guestInformations.lastname) && $guestInformations.lastname}{$guestInformations.lastname}{/if}" />
              </div>
