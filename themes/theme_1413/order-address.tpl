...
{else}
  ...
  <h4 class="step-num"><span>1</span> {l s='Addresses'}</h4>
...
<div class="addresses clearfix">
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12"{if $cart->isVirtualCart()} style="display:none;"{/if}>
      <ul class="address item box" id="address_delivery" style="text-align: center;
    text-transform: none;
    font-size: 15px;
    font-weight: normal;
    border-radius: 4px;
    ...
    <div class="col-xs-12 col-sm-12">
      <ul class="address alternate_item{if $cart->isVirtualCart()} full_width{/if} box" id="address_invoice" style="text-align: center;
    text-transform: none;
    font-size: 15px;
    font-weight: normal;
    border-radius: 4px;
