...
$(document).ready(function(){
  countItemsPack();
  if ($('.products_block.block-pack').length && !!$.prototype.bxSlider) {
    block_pack_slider = $('#blockpack').bxSlider({
      minSlides: pack_carousel_items,
      maxSlides: pack_carousel_items,
      slideWidth: 500,
      slideMargin: 15,
      pager: false,
      nextText: '',
...
function resizeCarouselPack(){
  countItemsPack();
  block_pack_slider.reloadSlider({
    minSlides: pack_carousel_items,
    maxSlides: pack_carousel_items,
    slideWidth: 500,
    slideMargin: 15,
...
function countItemsPack()
{
  if ($('.products_block.block-pack').width() < 400)
    pack_carousel_items = 1;
  if ($('.products_block.block-pack').width() > 400)
    pack_carousel_items = 2;
  if ($('.products_block.block-pack').width() >= 550)
     pack_carousel_items = 2;
  if ($('.products_block.block-pack').width() >= 900)
     pack_carousel_items = 3;
  if ($('.products_block.block-pack').width() >= 1200)
     pack_carousel_items = 4;
  if ($('.products_block.block-pack').width() >= 1500)
     pack_carousel_items = 4;
  if ($('.products_block.block-pack').width() >= 1800)
     pack_carousel_items = 4;
  if ($('.products_block.block-pack').width() >= 2048)
     pack_carousel_items = 4;
}
