...
{if !isset($email_create)}
  <div class="row">
    <div class="col-xs-12 col-sm-{12/$linkWidth}">
      <form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}{if isset($type) and isset($id_product) }?type={$type}&id_product={$id_product}{/if}" method="post" id="create-account_form" class="box">
        ...
        <div class="form_content clearfix">
          ...
          <div class="submit">
            ...
            <div class="social-login-buttons" style="margin-top:10px"><div>
                ...
                <a title="Login with your Google Account" style="margin-top:10px" class="button_large btn btn-login-google" {if isset($back) && $back}href="{$link->getModuleLink('tmheaderaccount', 'googlelogin', ['back' => $back], true)}" {else}href="{$link->getModuleLink('tmheaderaccount', 'googlelogin', [], true)}"{/if}>
    ...
    <div class="col-xs-12 col-sm-{12/$linkWidth}">
      <form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}{if isset($type) and isset($id_product) }?type={$type}&id_product={$id_product}{/if}" method="post" id="login_form" class="box">
